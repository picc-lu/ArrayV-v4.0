...
final public class BinaryBidirectionalConditionalInsertionSort extends Sort {
    public BinaryBidirectionalConditionalInsertionSort(ArrayVisualizer arrayVisualizer) {
        ...
        this.setSortListName("Binary Bidirectional Conditional Insertion Sort");
        this.setRunAllSortsName("Binary Bidirectional Conditional Insertion Sort");
        this.setRunSortName("Binary Bidirectional Conditional Insertion Sort");
    ...
    public void binaryInsertOneElement(int[] array, int unsortedIndex, int end, double sleep, boolean auxwrite) throws Exception {
