...
final public class CocktailThreePartSort extends Sort {
    public CocktailThreePartSort(ArrayVisualizer arrayVisualizer) {
        ...
        this.setSortListName("Cocktail Three Part Sort");
        this.setRunAllSortsName("Cocktail Three Part Sort");
        this.setRunSortName("Cocktail Three Part Sort");
        this.setCategory("Extra Sorts");

        this.setBucketSort(false);
        this.setRadixSort(false);
        this.setUnreasonablySlow(true);
        this.setUnreasonableLimit(8000);
